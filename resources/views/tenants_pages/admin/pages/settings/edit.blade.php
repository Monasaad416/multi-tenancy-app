                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class='form-control  @error('phone1') is-invalid @enderror' name='phone1' value={{ $settings->phone1}} >
                        </div>
                        <div class="col-md-6">
                            <label for='phone2'>هاتف 2</label>
                            <input type="text" class='form-control  @error('phone2') is-invalid @enderror' name='phone2' value={{ $settings->phone2}} >
                        </div>
                        <div class="col-md-6">
                            <label for='phone3'>هاتف 3</label>
                            <input type="text" class='form-control  @error('phone3') is-invalid @enderror' name='phone3' value={{ $settings->phone3}} >
                        </div>
