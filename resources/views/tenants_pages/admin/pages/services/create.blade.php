                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group col-6">
                                            ...
                                            <textarea name='description_ar' rows="5" class= 'form-control mt-1 mb-3 @error('description_ar') is-invalid @enderror' placeholder = "وصف الخدمة باللغة العربية"></textarea>
                                        </div>

                                        <div class="form-group col-6">
                                            <label for='description_en'>وصف الخدمة باللغة الإنجليزية</label>
                                            <textarea name='description_en' rows="5" class= 'form-control mt-1 mb-3 @error('description_en') is-invalid @enderror' placeholder = "وصف الخدمة باللغة الإنجليزية"></textarea>
                                        </div>
                                    </div>
        ...
        $(document).ready(function () {
            $('select[name="category_id"]').on('change', function () {
                ...
                if (category_id) {
                    console.log(category_id);
                    $.ajax({
                        url: "{{ URL::to('/admin/section')}}/" + category_id,
                        type: "GET",
                        dataType: "json",
