                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="form-group col-6">
                                            ...
                                            <input type='text' name='name_ar' class= 'form-control mt-1 mb-3  @error('name_ar') is-invalid @enderror' value="{{ old('name_ar' , $service->name_ar) }}" placeholder = "إسم الخدمة باللغة العربية">
                                        </div>

                                        <div class="form-group col-6">
                                            <label for='name_en'>إسم الخدمة باللغة الإنجليزية</label>
                                            <input type='text' name='name_en' class= 'form-control mt-1 mb-3  @error('name_en') is-invalid @enderror' value="{{ old('name_en' , $service->name_en) }}" placeholder = "إسم الخدمة باللغة الإنجليزية">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group col-6">
                                            ...
                                            <input type='text' name='short_description_ar' class= 'form-control mt-1 mb-3  @error('short_description_ar') is-invalid @enderror' value="{{ old('short_description_ar' , $service->short_description_ar) }}" placeholder = "وصف قصير للخدمة باللغة العربية">
                                        </div>

                                        <div class="form-group col-6">
                                            <label for='short_description_en'>وصف قصير للخدمة باللغة الإنجليزية</label>
                                            <input type='text' name='short_description_en' class= 'form-control mt-1 mb-3  @error('short_description_en') is-invalid @enderror' value="{{ old('short_description_en' , $service->short_description_en) }}" placeholder = "وصف قصير للخدمة باللغة الإنجليزية">
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group col-6">
                                            ...
                                            <textarea name='description_ar' class= 'form-control mt-1 mb-3  @error('description_ar') is-invalid @enderror' id="description_ar" value="{{ old('description_ar' , $service->description_ar) }}" placeholder = "وصف الخدمة باللغة العربية">{{ $service->description_ar }}</textarea>
                                        </div>

                                        <div class="form-group col-6">
                                            <label for='description_en'>وصف الخدمة باللغة الإنجليزية</label>
                                            <textarea name='description_en' class= 'form-control mt-1 mb-3  @error('description_en') is-invalid @enderror' id="description_en" value="{{ old('description_en' , $service->description_en) }}" placeholder = "وصف الخدمة باللغة الإنجليزية">{{ $service->description_en }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type='number' min="0" step="any" name='price' class= 'form-control mt-1 mb-3  @error('short_description_ar') is-invalid @enderror' value="{{ old('price' , $service->price) }}" placeholder = "سعر الخدمة  ">
                                        </div>
