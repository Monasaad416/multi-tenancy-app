			...
			<div class="row row-sm my-2">
				<div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden sales-card bg-primary-gradient">
						<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
							<div class="">
								<h6 class="mb-3 tx-12 text-white">إجمالي عدد المشتركين</h6>
							</div>
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
										<h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Tenant::count()}}مشترك</h4>
										<p class="mb-0 tx-12 text-white op-7">مقارنة بالشهر السابق</p>
									</div>
									@php
										$noOfTenantsLastMonth =  App\Models\Tenant::get()
											->whereBetween('created_at', 
												[Carbon\Carbon::now()->subMonth()->startOfMonth(), Carbon\Carbon::now()->subMonth()->endOfMonth()]
											)
											->count();

										$noOfTenantsCurrentMonth =  App\Models\Tenant::get()
											->whereBetween('created_at', 
									...
									<span class="float-right my-auto mr-auto">
										...
										@if($noOfTenantsLastMonth != 0 )
											@if( $noOfTenantsCurrentMonth / $noOfTenantsLastMonth > 1)
												<i class="fas fa-arrow-circle-up text-white"></i>
											@elseif($noOfTenantsCurrentMonth  / $noOfTenantsLastMonth < 1)
												<i class="fas fa-arrow-circle-down text-white"></i>
											@endif
											<span class="text-white op-7"> {{ $noOfTenantsCurrentMonth  / $noOfTenantsLastMonth  }}</span>
										@else 
											<span class="text-white op-7">لايوجد مشتركين بالشهر السابق</span>
										@endif		
									</span>
								</div>
							</div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden sales-card bg-warning-gradient">
						<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
							<div class="">
								<h6 class="mb-3 tx-12 text-white">إجمالي عدد الباقات</h6>
							</div>
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
										<h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Bundle::count()}} باقة</h4>
					...
					<div class="card">
						<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
							<div class="d-flex justify-content-between">
								<h4 class="card-title mb-0">الباقات</h4>
								<i class="mdi mdi-dots-horizontal text-gray"></i>
							</div>
							<p class="tx-12 text-muted mb-0">متابعةأعداد المشتركين بالباقات</p>
						</div>
						<div class="card-body">
							<div class="total-revenue">
								@foreach($counter as $key => $bundleCount)
									@php
									...
									<div>
										...
										<h4>{{$bundleCount}}</h4>
										<label><span class="bg-{{$color[$key]}}"></span>{{$bundles[$key]}}</label>
									</div>
								@endforeach
				
							</div>
							<div style="width:75%; margin-top: 60px;">
								{!! $chartjs->render() !!}
							</div>
						</div>
					</div>
							...
							<div class="list-group list-lg-group list-group-flush">
								<div class="list-group-item list-group-item-action" href="#">
									<div class="media mt-0">
										<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{url('dashboard/assets/img/faces/3.jpg')}}" alt="Image description">
								...
								<div class="list-group-item list-group-item-action" href="#">
									<div class="media mt-0">
										<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{url('dashboard/assets/img/faces/11.jpg')}}" alt="Image description">
										<div class="media-body">
											<div class="d-flex align-items-center">
												<div class="mt-1">
								...
								<div class="list-group-item list-group-item-action" href="#">
									<div class="media mt-0">
										<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{url('dashboard/assets/img/faces/17.jpg')}}" alt="Image description">
										<div class="media-body">
											<div class="d-flex align-items-center">
												<div class="mt-1">
								...
								<div class="list-group-item list-group-item-action" href="#">
									<div class="media mt-0">
										<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{url('dashboard/assets/img/faces/15.jpg')}}" alt="Image description">
										<div class="media-body">
											<div class="d-flex align-items-center">
												<div class="mt-1">
								...
								<div class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
									<div class="media mt-0">
										<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{url('dashboard/assets/img/faces/6.jpg')}}" alt="Image description">
										<div class="media-body">
											<div class="d-flex align-items-center">
												<div class="mt-1">
